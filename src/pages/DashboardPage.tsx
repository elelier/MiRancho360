    ...
    <div className="min-h-screen bg-background">
      ...
      {showMenu && (
        <div className="fixed inset-0 bg-black bg-opacity-60 z-50" onClick={() => setShowMenu(false)}>
          <div className="fixed left-0 top-0 w-96 h-full bg-gradient-to-b from-primary-600 to-primary-700 shadow-2xl">
            ...
            <div className="py-6 space-y-2">
              ...
              >
                ...
                <span className="text-xl font-bold text-white drop-shadow-sm">Inicio</span>
              </button>

              <button 
                onClick={() => { navigate('/animales'); setShowMenu(false); }} 
                className="w-full flex items-center space-x-5 px-8 py-5 hover:bg-white/20 transition-all duration-200 backdrop-blur-sm"
                aria-label="Gestionar animales"
              >
                <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center flex-shrink-0 backdrop-blur-sm">
                  <Icon name="cow-large" className="w-7 h-7 text-white" />
                </div>
                <span className="text-xl font-bold text-white drop-shadow-sm">Animales</span>
              </button>

              <button 
                onClick={() => { navigate('/sitios'); setShowMenu(false); }} 
                className="w-full flex items-center space-x-5 px-8 py-5 hover:bg-white/20 transition-all duration-200 backdrop-blur-sm"
                aria-label="Gestionar sitios"
              >
                <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center flex-shrink-0 backdrop-blur-sm">
                  <Icon name="farm-house" className="w-7 h-7 text-white" />
                </div>
                <span className="text-xl font-bold text-white drop-shadow-sm">Sitios</span>
              </button>
              ...
              >
                ...
                <span className="text-xl font-bold text-white drop-shadow-sm">Reportes</span>
              </button>
